...
$_['text_generated_config'] = 'Ключи получены через «Подключить Paymos» и зашифрованы в этой установке OpenCart.';
$_['text_manual_config'] = 'Магазин не подключён. Нажмите «Подключить Paymos» и подтвердите текущий проект.';
$_['text_manual_credentials'] = 'Подключение';
...
$_['help_webhook_url'] = 'Paymos регистрирует этот адрес для Sandbox и Live автоматически при подключении магазина.';
