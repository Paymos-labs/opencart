...
Credentials and temporary device state are stored as a AES-256-GCM OpenCart setting keyed from config_encryption. Saved secrets are not rendered back into the administration page.
